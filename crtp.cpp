...
// In short, CRTP is when a class A has a base class which is a template specialization for the
// class A itself. E.g.
//
// template <class T>
// class X{...};
...
// Using this technique, CRTP could be used to implement static polymorphism(which like dynamic
// polymorphism but without virtual function pointer table). This will drastically reduces code
// dups.
#include <fstream>
#include <iostream>
...
class FileWriter : public Writer<FileWriter> {
 public:
  ...
  void writeImpl(string something) const { cout << "FileWriter write something" << endl; }
};
