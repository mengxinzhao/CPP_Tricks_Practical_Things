...
//with ownership (which follows from the Single Responsibility Principle)
//
//When a base class is intended for polymorphic use, its destructor may have to be declared public and virtual. 
//This blocks implicit moves (and deprecates implicit copies), and so the special member functions have to be declared 
//as defaulted
